...
const Payment = () => {
  ...
  const Row = ({idx}) => {
    ...
    const calcPrice = (e) => {
      ...
      let unitPrice = target==='unitPrice'? Number(value) : Number(detailForm.unitPrice);
      let discount = target==='discount'? Number(value) : Number(detailForm.discount);
      let taxRate = target==='taxRate'? Number(value) : Number(detailForm.taxRate);
      let itemCount = target==='itemCount'? Number(value) : Number(detailForm.itemCount);
      let wPrice = '';
